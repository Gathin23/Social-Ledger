...
export default function NftDisplay({items}) {
    ...
    return (
        ...
        <div className="mt-12 grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
          {
            items.map((items, key) => (
              <div className="max-w-md mx-auto mt-4 shadow-lg border rounded-md duration-300 hover:shadow-sm bg-white bg-opacity-60 p-6 rounded-lg shadow-xl backdrop-filter backdrop-blur-lg" key={key}>
                <a href={items.href}>
